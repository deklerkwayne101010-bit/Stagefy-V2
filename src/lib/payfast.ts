...
// Credit packages for one-time purchases (prices in ZAR, R0.90-R1.80 per credit)
export const CREDIT_PACKAGES = [
  { id: '50_credits', name: '50 Credits', price: 90, credits: 50 },
  { id: '100_credits', name: '100 Credits', price: 140, credits: 100 },
  { id: '250_credits', name: '250 Credits', price: 275, credits: 250, badge: 'Most Popular' },
  { id: '500_credits', name: '500 Credits', price: 450, credits: 500, badge: 'Best Value' },
]
