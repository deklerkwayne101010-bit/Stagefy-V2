    ...
    <div className="min-h-screen">
      ...
      <section className="hero-gradient pt-24 pb-20 lg:pt-32 lg:pb-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <p className="text-sm text-slate-500 mt-4">Free to try • No credit card required • 3 free credits</p>
          </div>
      ...
      <section className="cta-gradient py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm text-blue-200 mt-4">No credit card required • 3 free credits • Buy more anytime</p>
        </div>
      </section>
