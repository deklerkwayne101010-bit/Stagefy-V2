...
export function AgentShowcaseWizard({
  ...
  const handleGenerate = () => {
    ...
    if (designStyle === 'business_card') {
      ...
      prompt = `Create an agent personal branding image with large prominent tagline "Create a tagline focused on property investors" as the focus. Include small agent photo in corner, name "Anne de klerk" in elegant typography below tagline. Use square orientation. Use ${mainColor} as the main background color, ${secondaryColor} for text/elements, and ${accentColor} for highlights/accents following 60/30/10 design rule. Agent contact info: Phone: 0642176889, Email: anned@symprop.co.za. IMPORTANT: This is a QUOTE-FOCUSED design - do NOT include any property photos or property images in the design - only agent branding elements (agent photo, name, tagline, contact details).`
