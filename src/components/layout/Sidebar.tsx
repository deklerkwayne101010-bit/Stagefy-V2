...
const navigation = [
  ...
  // Content Planner - Hidden from sidebar until fully ready
  // Access via direct URL: /dashboard/calendar
  // {
  ...
  // },
  {
    ...
    children: [
      ...
      // Content Calendar - Hidden until fully ready
      // { name: 'Content Calendar', href: '/dashboard/calendar' },
    ],
  },
  {
